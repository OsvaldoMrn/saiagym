        ...
        return (
                <View style={styles.container}>
                        ...
                        <TextInput
                                ...
                                onEndEditing={checkEmailAvailability}
                        />
                        {loadingEmailCheck && <ActivityIndicator size="small" color="#22D3EE" style={styles.spinner} />}
                        {emailError ? (
                                <Text style={styles.errorText}>{String(emailError)}</Text>
                        ...
                        {formError ? <Text style={styles.errorText}>{String(formError)}</Text> : null}

                        <Text style={styles.termsText}>
                                Al continuar, es porque estas de acuerdo con{' '}
                                <Text style={styles.link}>los términos de los servicios</Text>{' '}y{' '}
                                <Text style={styles.link}>la política de privacidad</Text>.
                        </Text>
